	    ...
	    <div class="panel-body">
			<div class="row">		
				...
				<div class="col-md-6 col-sm-6 already-registered-login">
                    ...
                    <h4 class="unicase-checkout-title"><strong>Payment Info</strong></h4>
...
var stripe = Stripe('pk_test_51LiIJNCe1Kb2UBPsTBBolpmwhYYb7o6bp6LP1WACSmezHgcQ3kM3bSYcUGGbZJbrf3Jo7MvZa5nCK0ARMEdftwyW00iBtVWGUp'); //published key
